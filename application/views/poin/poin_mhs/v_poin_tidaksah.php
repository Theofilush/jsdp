                            ...
                            <div class="row justify-content-center">
                            	<div class="col-md-6 mb-20">
                                    <div class="list-group">
                                    	...
                                    	<a class="list-group-item d-flex justify-content-between align-items-center list-group-item-action active" href="<?php echo site_url() ?>Poin/TidakSah" >
                                ...
                                <div class="col-md-12 text-center">
                                    <div class="btn-group mb-15" role="group" aria-label="Basic example">
                                        <a type="button" class="btn btn-light" href="<?php echo site_url() ?>Poin">Sah</a>
                                        <a type="button" class="btn btn-light" href="<?php echo site_url() ?>Poin/Menunggu">Menunggu diverifikasi</a>
                                        <a type="button" class="btn btn-light active" href="#">Tidak Sah</a>
                                    </div>
                                </div>
